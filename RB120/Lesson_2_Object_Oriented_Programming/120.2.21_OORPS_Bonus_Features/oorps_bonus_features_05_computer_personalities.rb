...
module Players
  ...
  class Human < Player
    ...
    def choose_move
      ...
      loop do
        ...
        puts "You can also abbreviate with r, p, s, l, or sp!"
  ...
  module Computers
    ...
    class Computer < Player
      def set_name
        self.name = self.class.to_s.split('::').last
      end
...
class RPSGame
  ...
  def choose_opponent
    ...
    loop do
      ...
      break if Players::Computers::ROBOTS.include?(answer)
      puts "Sorry, please choose from the provided choices."
    end
    @computer = Object.const_get("Players::Computers::#{answer}").new
